...
Arguments:
  ...
  <DESTINATION_PATH>  The destination/file directory to copy to. If this does not exist, it will be created
...
Options:
  ...
  -v, --verbose
      ...
      --concurrency <CONCURRENCY>
          The number of threads to use for hashing and copying. A single thread will be used for scanning. Defaults to `8` or the number of CPU cores, whichever is smaller [default: 8]
      --exclusive-lock
